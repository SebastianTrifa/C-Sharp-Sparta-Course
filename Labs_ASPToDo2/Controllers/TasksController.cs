...
namespace Labs_ASPToDo2.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TaskId,TaskDescription,Done,DateStarted,DateFinished,CategoryID,UserID")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TaskId,TaskDescription,Done,DateStarted,DateFinished,CategoryID,UserID")] Task task)
        {
            if (ModelState.IsValid)
            {
